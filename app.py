...
<div class="main-header">
    ...
    <p>Tác giả: Bùi Hải Bình - Trường Tiểu học Minh Quang - ĐT: 0386 036 899</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Bùi Hải Bình - Trường Tiểu học Minh Quang - ĐT: 0386 036 899</div>", unsafe_allow_html=True)
